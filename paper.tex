...
\item[example] Typical usage of functions. (TBD(@sol): more vocal)
...
to disclose examples/properties for users as user documentation.
...
\item Haskell community does not have a BBD tool for 
...
To specify examples/properties for users, we propose to add two new markups to Haddock and to use {\tt doctest} integrated with QuickCheck. To describe examples/properties for developers, we propose to use \hspec{} also integrated with QuickCheck.
