...
code blocks, but no markup syntax for evidence.
As mentioned before, we implemented support for interactive examples ({\tt >>>}) in 2010.
It is available in Haddock version 2.8 or later.
We also added support for markup of properties ({\tt prop>}) which
will be available in a future release of Haddock.
