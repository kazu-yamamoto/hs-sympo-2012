...
Both, Doctest and Hspec were missing some features.  So we extended
them as needed.  In particular, our contributions are:
...
can be used for design, documentation and automated testing.
...
\begin{quote}
    kazu: Monoid is already described in Introduction. Why is this
    repeated? And ``code documentation'' is aslo already dicussed in
    Introduction. I think we can use ``code documentation'' here.

    sol: We reuse Monoid here, but we make a different point.  So this
    still adds something, and I think we need it.
\end{quote}
