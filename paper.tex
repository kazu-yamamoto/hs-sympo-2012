...
For code documentation, we also make use of Hspec inspired by RSpec~\cite{rspec}
and we proposed some combinators to it.

Automating such as test discovery and continuous integration (CI) ~\cite{ci} 
is an important aspect of BDD. TBD: need to say somting.
...
\item
    ...
    \emph{code examples} for use with Hspec. (Section \ref{sec:for-developers})
