...
\begin{quote}
kazu: I guess ``Doctest integrated with QuickCheck'' is better.

sol: @kazu, yes, I agree.
\end{quote}
...
\begin{quote}
    TBD: ``Section'' to ``section''

kazu: ``Section X.Y'' is perfect English, i.e. a proper noun.
      ``The following three sections'' is also perfect, i.e. a ordinal noun.
\end{quote}
