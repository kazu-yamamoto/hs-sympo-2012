...
motives Haskellers to write test code.
...
mainly based on example test. When we bring them to
...
Visible behaviors are those which are useful for for both developers and users.
...
Haddock version 2.7.2 or earlier does not provide annotation syntax 
