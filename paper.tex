...
Hspec is thus useful for code documentation but we observed that parts
...
There is Haskell version of Doctest\footnote{%
http://hackage.haskell.org/package/doctest} coped with Haddock~\cite{haddock},
standard documentation mechanism for Haskell.
