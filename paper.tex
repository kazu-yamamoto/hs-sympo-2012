...
To test properties, we use GHCi.  Each property is enclosed within
``\verb|quickCheck (|'' and ``\verb|)|'', and GHCi is used to evaluate
that.  GHCi output is used to decide, whether the property succeeded,
or failed.

If a property contains free variables, we need to add lambda
