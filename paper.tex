...
includes TDD, amongst other software development methods, but
...
BDD-style TDD has been pioneered by RSpec~\cite{rspec}.  In this
paper, we explore how to apply the TDD aspect of BDD to Haskell.
