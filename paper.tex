...
specification so that zero should be the result for negative inputs.
...
library.  We always extend or adapt the specification and watch it
fail first.  Then, we fix the implementation.  The combinators {\tt
shouldBe}, {\tt shouldReturn} and {\tt shouldThrow} can be used to
specify behavior of functions in an intuitive, easy to read manner.
The final version of our library looks like this.
