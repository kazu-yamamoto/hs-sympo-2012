...
for evidence for users.
To specify evidence for developers,
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Evidence for developers}
...
Next we write evidence for users in Haddock markup:
...
Also, we specifies evidence for developers with Hspec:
