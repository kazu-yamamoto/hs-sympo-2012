...
\begin{quote}
kazu: the two paragraphs above doe not seem logical to me. I would change these
as follows:
...
\begin{quote}
    sol: remove?
    kazu: yes. But I would add a sentence such as ``This section
    will discuss problems when we try to use these tools for BDD''.
