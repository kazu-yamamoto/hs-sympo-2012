...
Haddock has markup support for code blocks~\cite{haddock}.  And it is widely used to
include properties and examples in documentation.
For instance, some packages, including {\tt containers}, {\tt filepath}, 
{\tt bytestring} and {\tt text}, adopt this style.
Here is an example from the first one.
