...
\begin{quote}
    TBD: Not correct English, so we have to find an other way to say
    this.

    The following subsections disccuss problems when we try to carry
    out our proposal of BDD.
\end{quote}

\subsection{Doctest and Haddock}

Haddock has markup support for code blocks~\cite{haddock}.  And
they are widely used to include properties and examples into
documentation.
