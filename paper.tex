...
23.should eq(23)
        ...
        \begin{verbatim}
expect {launche_missiles}.to raise_error
        \end{verbatim}
    ...
    \item Motivate \verb|shouldThrow|
...
We propose to use three combinators to set expectations about the
outcome of code examples.
